...
function CustomerListView() {
  ...
  const getCustomers = useCallback(() => {
    ...
    axios
      .get(API_BASE_URL + 'assessments/moonquiz/editQuestion/' + params.Id)
      .then((response) => {
  ...
  const onSubmitSuccess = (values) => {
    axios
      .post(API_BASE_URL + 'assessments/moonquiz/saveQuestion',{
        values,
  ...
  const DeleteQuestion = (quesId) => {
    axios
    .post(API_BASE_URL + 'assessments/moonquiz/deleteQuestion',{
      assessmentId:params.Id,
      quesId
    })
    .then((response) => {
