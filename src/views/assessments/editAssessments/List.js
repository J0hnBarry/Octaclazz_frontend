...
function Results({ className, Myassessments, ...rest }) {
 ...
 const DeleteAssessment = (assessmentId) => {
  axios
  .get(API_BASE_URL + 'assessments/assessments/delete/' + assessmentId)
  .then((response) => {
              ...
              {paginatedCustomers.map((assessment) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                    {moment(assessment.dateline).format('YYYY-MM-DD HH:mm')}
                    </TableCell>     
                    <TableCell>
                    ...
                    <IconButton
                        ...
                        to={"/app/assessments/assessments/gamification/" + assessment._id}
                      >
                    ...
                    <IconButton
                        component={RouterLink}
                        to={"/app/assessments/assessments/update/" + assessment._id}
                      >
                        <SvgIcon fontSize="small">
                          <EditIcon />
                        </SvgIcon>
                    ...
                    <IconButton
                        component={RouterLink}
                        to={"/app/assessments/assessments/updateAssess/" + assessment._id}
                      >
                        <SvgIcon fontSize="small">
                          <EditIcon />
                        </SvgIcon>
